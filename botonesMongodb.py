...
import embarqueMongodb
import cosechaMongodb
import finanzasMongodb
import calculosMongodb
...
def mostrarBotones(on_return):
    ...
    def ocultarBotonesco():
        root.withdraw() 
        cosechaMongodb.mostrarCosecha(mostrarBot)

    def ocultarBotonesca():
        root.withdraw()
        embarqueMongodb.mostrarEmbarque(mostrarBot)

    def ocultarBotonesfi():
        root.withdraw()
        finanzasMongodb.mostrarFinanzas(mostrarBot)

    def ocultarBotonescalc():
        root.withdraw()
        calculosMongodb.mostrarCalculos(mostrarBot)
