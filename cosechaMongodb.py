...
def mostrarCosecha(on_return):
    ...
    btnEliminar = customtkinter.CTkButton(marco2, text="Eliminar", command=eliminarFila)
    btnEliminar.grid(column=1, row=3, padx=10, pady=10)
    btnActualizar = customtkinter.CTkButton(marco2, text="Actualizar", command=actualizarDatos)
