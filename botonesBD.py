...
def mostrarBotones(on_return):
    ...
    def ocultarBotonesco():
        root.withdraw() 
        main.mostrarCosecha(mostrarBot)

    def ocultarBotonesca():
        root.withdraw()
        Caja.mostrarCaja(mostrarBot)

    def ocultarBotonesfi():
        root.withdraw()
        finanzas.mostrarFinanzas(mostrarBot)

    def ocultarBotonescalc():
        root.withdraw()
        calculos_estimaciones.mostrarCalculo(mostrarBot)
